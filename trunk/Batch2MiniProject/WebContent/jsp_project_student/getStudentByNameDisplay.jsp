...
<%@page import="com.student.display.StudentDisplay" %>
...
<%Student stu = (Student)session.getAttribute("studentByName");
StudentDisplay studentDisplay = null;%>
<%=
	studentDisplay.displayStudent(stu)%>
<br><br>
