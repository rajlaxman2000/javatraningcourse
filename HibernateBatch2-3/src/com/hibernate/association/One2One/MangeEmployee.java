...
public class MangeEmployee {
	...
	public static void main(String[] args) {
		...
		Employee employee1 = new Employee("Rajesh", "Reddy", 100000, address1);
			int empId1 = mangeEmployee.addEmployee(employee1);
			System.out.println("This employee with ID "+empId1+" inserted");
			
		Address address2 = new Address("56-76-987", "JNTU", "Hyderabad");
			int addId2 = mangeEmployee.addAddress(address2);
			address2.setAddId(addId2);
		
		Employee employee2 = new Employee("Srinu", "Reddy", 50000, address2);
